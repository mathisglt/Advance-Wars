 ...
 */
    ...
    Color grisnoir = new Color(98,90,99);
    for (int i=0;i<= Config.longueurCarteXCases; i++) {
            dessineLigne(positionInterneCarteX((double) i / (double) Config.longueurCarteXCases), positionInterneCarteY(0), positionInterneCarteX((double) i / (double) Config.longueurCarteXCases), positionInterneCarteY(1), grisnoir);
        }
    for (int i=0;i<= Config.longueurCarteYCases; i++) {
            dessineLigne(positionInterneCarteX(0),positionInterneCarteY(((double) i) / (double) Config.longueurCarteYCases), positionInterneCarteX(1), positionInterneCarteY(((double) i) / (double) Config.longueurCarteYCases), grisnoir);
        }
    }
